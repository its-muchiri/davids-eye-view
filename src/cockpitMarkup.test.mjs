...
test('Cockpit owns a focused shared Display portal and compact Radio controls', () => {
  ...
  assert.match(css, /\.cockpit-utility-control\.is-expanded \.cockpit-utility-divider\s*\{[\s\S]*?linear-gradient\(90deg, rgb\(255 196 0 \/ 28%\), rgba\(255, 196, 0, 0\.18\) 58%, transparent\)[\s\S]*?box-shadow:\s*0 0 7px rgba\(255, 196, 0, \.22\);/);
