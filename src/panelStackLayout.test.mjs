...
test('expanded left panels integrate their headers with the container shell', () => {
  ...
  assert.match(
    css,
    /#left-panel-stack > \[data-panel-id\]:not\(\.collapsed\) \.panel-divider\s*\{[\s\S]*?linear-gradient\(90deg, rgb\(255 196 0 \/ 28%\), rgba\(255, 196, 0, 0\.18\) 58%, transparent\)[\s\S]*?box-shadow:\s*0 0 7px rgba\(255, 196, 0, 0\.22\);/,
  );
});
...
test('expanded right panels highlight the title divider without changing collapsed launchers', () => {
  ...
  assert.match(
    css,
    /#right-context-rail \[data-panel-id\]:not\(\.collapsed\) \.panel-divider\s*\{[\s\S]*?linear-gradient\(90deg, rgb\(255 196 0 \/ 28%\), rgba\(255, 196, 0, 0\.18\) 58%, transparent\)[\s\S]*?box-shadow:\s*0 0 7px rgba\(255, 196, 0, 0\.22\);/,
  );
  assert.match(
    css,
    /#param-slider-panel:not\(\.collapsed\) \.param-panel-divider\s*\{[\s\S]*?linear-gradient\(90deg, rgb\(255 196 0 \/ 28%\), rgba\(255, 196, 0, 0\.18\) 58%, transparent\);/,
  );
});
