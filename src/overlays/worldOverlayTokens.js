...
export const WORLD_OVERLAY_STYLE = Object.freeze({
  ...
  selectedBackground: 'rgba(13, 5, 24, 0.94)',
  border: 'rgba(242, 230, 190, 0.18)',
  selectedBorder: 'rgba(255, 220, 107, 0.72)',
  title: 'rgba(244, 241, 232, 0.96)',
  detail: 'rgba(147, 161, 173, 0.92)',
  leader: 'rgba(228, 209, 147, 0.58)',
  accent: '#ffdc6b',
...
export const CCTV_THUMBNAIL_STYLE = Object.freeze({
  ...
  titleColor: 'rgba(244, 236, 210, 0.95)',
  titleFont: '600 10px "JetBrains Mono", monospace',
  accent: 'rgb(255, 220, 107)',
  leader: 'rgba(255, 220, 107, 0.6)',
  rule: 'rgba(255, 220, 107, 0.95)',
  ruleHeight: 2,
  radius: 4,
});
